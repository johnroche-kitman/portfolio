...
<title>Individual Development Plans — iP prototype</title>
...
<div id="gate">
  <form id="f" autocomplete="off">
    ...
    <p class="sub">Every athlete’s season plan: development goals, the clips tagged against them, and the coach’s running review. Encrypted; same passphrase as the other prototypes.</p>
