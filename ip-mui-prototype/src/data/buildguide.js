    ...
    surfaces: [
      ...
      },
      {
        ...
        notes: [
          ...
          'Periods are a small exclusive `ToggleButtonGroup` (Split Evenly against manual) with a minutes field beside it carrying a "min" adornment. This is the input that feeds the period timeline on the game’s own Game events tab, so the two need to agree on the model.',
