...
export const events = [
  ...
  mk('crgtst', EVENT_TYPES.SESSION, 0, '10:00', '11:00', { sessionType: '1st Team Training', complete: true }),
  ...
  mk('Training passing', EVENT_TYPES.SESSION, 2, '08:30', '09:30', { sessionType: 'Training passing', complete: true }),
  ...
  mk('PM Training', EVENT_TYPES.SESSION, 3, '14:30', '15:30', { sessionType: '1st Team Training', complete: true }),
